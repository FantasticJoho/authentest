...
using (var scope = app.Services.CreateScope())
{
    ...
    var seedUsers = new[] {
        new AuthTest.Api.Models.User { Username = "jonathan", PasswordHash = BCrypt.Net.BCrypt.HashPassword("Pas$word2", 12), MustChangePassword = false },
        new AuthTest.Api.Models.User { Username = "virginie",  PasswordHash = BCrypt.Net.BCrypt.HashPassword("Pas$word2", 12), MustChangePassword = false }
    };
